...
:white_check_mark: **2017.02.20** - 3쇄가 출간되었습니다. 크고 작은 오류를 잡는 김에 책 전체를 한 번 더 교정했습니다. 그렇다고 다른 게 아니니 1, 2쇄를 보신 분은 오탈자 정보만 확인하시면 충분합니다. 책 품질은 이번처럼 기회가 올 때마다 지속해서 업그래이드할 것이니 궁금하거나 설명이 잘 이해되지 않으면 언제든 문의하세요~
...
각 장의 디렉터리로 이동한 후 파이썬 명령을 실행하세요.
